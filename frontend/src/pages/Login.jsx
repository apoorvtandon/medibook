...
const Login = () => {
  ...
  return (
    <section className='px-5 lg:px-0 mt-10 mb-20'>
        ...
        <form className='py-4 md:py-0' onSubmit={submitHandler}>
          <div className='mb-5'>
            <input
              ...
              className='w-full px-4 py-3 border-b border-solid border-[#0066ff61] focus:border-primaryColor text-[22px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer focus:outline-none'
              required
            />
          </div>
          <div className='mb-5'>
